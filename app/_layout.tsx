    ...
    <ThemeProvider value={AppTheme}>
      <View style={styles.root}>
        ...
        >
          ...
          <Stack.Screen name="profile/icon-picker" options={{ animation: 'slide_from_bottom', presentation: 'modal' }} />
          <Stack.Screen name="wallet/top-up" options={{ animation: 'slide_from_bottom', presentation: 'modal' }} />
